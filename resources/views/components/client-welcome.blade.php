<div class="container-fluid">
	<div class="row align-items-center" style="margin-top:40px;">
		...
		<div class="col-md-4">
			<img class="w-100 theme-radius theme-border" src="{{asset('images/client-home.png')}}">
		</div>
		<div class="col-md-1"></div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<div class="row">
				<div class="col-md">
					<img src="{{asset('images/step1.png')}}" class="w-100">
				</div>
				<div class="col-md d-flex align-content-center justify-content-center">
					<img src="{{asset('images/blue-dots.svg')}}" class="w-50 dots">
				</div>
				<div class="col-md">
					<div class="">
						<img src="{{asset('images/step2.png')}}" class="w-100">
					</div>
				</div>
				<div class="col-md d-flex align-content-center justify-content-center">
					<img src="{{asset('images/blue-dots.svg')}}" class="w-50 dots">
				...
				<div class="col-md">
					<div class="w-100">
						<img src="{{asset('images/step3.png')}}" class="w-100">
					</div>
				</div>
			</div>
			<div class="row">
	...
	<div class="row"  style="margin-top:50px;">
		...
		<div class="col-md-10">
			...
			{!!$texts[13]->text!!}
			<a href="{{route('learn-more-client')}}" class="theme-border theme-color" id="learn_more">{{$texts[14]->text}}</a>
		</div>
		<div class="col-md-1"></div>
	</div>
	<x-stats-counter/>
