											...
											<tr>
												<td>
													...
													<p style="{{ $style['paragraph-black'] }}">
														Your milestone {{$invoice->milestone_number}} of {{count($invoice->order->invoices)}} is completed. You can find it in attachments or in your dashboard if you have registration in hour portal.
														<br/>
													</p>
