                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/assets/email-pictures/User/Security_check_email.jpg') }}" width="600" style="{{ $style['image-hundred'] }}" alt="Image" />
                                        <table align="center" width="550" cellpadding="10" cellspacing="10">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">Your location IP or your device IP has changed. For security reasons we send you a PIN.</p>
                                                    <p style="{{ $style['paragraph-black'] }}">Your PIN is: {!! $pin !!}</p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                      Please go back to the login page where you already started your login, enter this PIN there, and log in. Kindly please note that this is a one-time PIN and will expire after use. Should you start a completely new login process, a new PIN will be required.  
                                                    </p>
                                                    <!-- Conclusion -->
                                                    <p style="{{ $style['paragraph-black'] }}">If you have further questions, please do not hesitate to contact our friendly support team.</p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
