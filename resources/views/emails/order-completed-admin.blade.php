											...
											<tr>
												<td>
													...
													<p style="{{ $style['paragraph-black'] }}">
														{{$invoice->freelancer->name}} finish his/her work on milestone {{$invoice->invoice_number}}.The project was approved from QA and the payment document
														is generated.The word file is sent to client. Please check your dashboard section finished orders  for more  details.
														<br/>
													</p>
