                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/assets/email-pictures/User/Conformation_email.jpg') }}" width="600" style="{{ $style['image-hundred'] }}" alt="Image" />
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Thank you very much for registering at GHOSTWRITING.COM. In order to confirm your registration, please click on the button below. If the button is not working, copy and paste the link below into your browser.
                                                        <br/>
                                                    </p>
                                                    <!-- Action Button -->
                                                    <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center">
                                                               <a style="{{$style['button']}} {{$style['button--blue']}}" href="{{route('verify-account',[$code])}}">Verify Account</a>
                                                            </td>
                                                        </tr>
                                                    </table>
