                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/assets/email-pictures/Freelancer/Admin_approve_Freelancer_Admin_can_pay_Freelancer_money.jpg') }}" width="600" style="{{ $style['image-hundred'] }}" alt="Image" />
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                      Your application was successfully approved! Welcome to GHOSTWRITING.COM  
                                                    </p>
                                                    <!-- Conclusion -->
