                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/assets/email-pictures/Freelancer/Will_not_work_anymore_on_this_project.jpg') }}" width="600" style="{{ $style['image-hundred'] }}" alt="Image" />
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                     	Unfortunately your application hasn't been approved.
                                                    </p>
                                                    <!-- Conclusion -->
