                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/assets/email-pictures/User/Conformation_email.jpg') }}" width="600" alt="Image" />
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{$link}}" style="{{ $fontFamily }} {{ $style['button'] }}" class="button" target="_blank">
                                                                    Change Password
                                                                </a>
                                                            </td>
                                                        </tr>
