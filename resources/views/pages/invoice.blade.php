    ...
    <div id="print">
        ...
        <table class="table tb-invoice" style="margin-top: 2rem; margin-bottom: 2rem;">
            ...
            <tr class="inv-label">
                ...
                <td style="width:40%;">{{$invoice->order->email}}</td>
            </tr>
            <tr class="inv-label">
                <td>VAT ID {{$invoice->contractor->vat}}</td>
                <td></td>
                <td>{{$invoice->order->phone}}</td>
            </tr>
        </table>
         ...
         <table class="table tb-invoice">
            ...
            <tr class="inv-label">
                ...
                <td style="text-align:right !important;">
                    &euro;{{ number_format((float)$invoice->price, 2, '.', ',')}}
                </td>
            </tr>
            @endif
            @endforeach
        ...
        <table class="table tb-invoice" style="margin-top:100px;">
            ...
            <tr class="inv-label">
                <td style="text-align: right!important;padding:5px;">&euro;{{number_format((float)$invoice->price,2,'.', ',')}}</td>
